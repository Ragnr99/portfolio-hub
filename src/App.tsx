...
import PalDrops from './pages/PalDrops'
import PalQuests from './pages/PalQuests'
      ...
      <Router basename={import.meta.env.BASE_URL}>
        ...
        <Layout>
          <Routes>
            ...
            <Route path="/palworld/drops" element={<PalDrops />} />
            <Route path="/palworld/quests" element={<PalQuests />} />
